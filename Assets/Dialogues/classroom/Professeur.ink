...
Bonjour, entrez chers élèves ! # action: students_enter # delay:3
...
# speaker: Alice
Je peux l'aider, j'ai déjà de l'experience avec un casque VR.

# speaker: Professeur Bob
Parfait ! je vous laisses faire, si l'un d'entre vous a une question, n'hésitez pas. # action: student_help
